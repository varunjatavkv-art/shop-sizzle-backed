...
class NodeEnvironment {
  ...
  constructor(config, _context) {
    ...
    this._globalsCleanupMode = (() => {
      const rawConfig = projectConfig.testEnvironmentOptions['globalsCleanupMode'];
      ...
      switch (config) {
        ...
        default:
          {
            if (config !== undefined) {
              (0, _jestValidate().logValidationWarning)('testEnvironmentOptions.globalsCleanupMode', `Unknown value given: ${rawConfig}`, 'Available options are: [hard, soft, off]');
            }
            return 'soft';
          }
      }
